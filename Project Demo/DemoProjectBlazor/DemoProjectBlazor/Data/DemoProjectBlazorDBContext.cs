...
public partial class DemoProjectBlazorDBContext : DbContext
{
    public DemoProjectBlazorDBContext()
    {
    }

    public DemoProjectBlazorDBContext(DbContextOptions<DemoProjectBlazorDBContext> options)
        : base(options)
    {
    }
